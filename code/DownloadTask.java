...
public class DownloadTask extends AsyncTask<String, Void, String> {
    ...
    static String getDirectionsUrl(LatLng origin, LatLng dest,ArrayList<LocationAddress> waypoints){
        ...
        for(LocationAddress address2:waypoints){
            waypoints2+="|"+address2.getLocationLat()+","+address2.getLocationLong();
        }
